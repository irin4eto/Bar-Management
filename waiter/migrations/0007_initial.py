...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Waiter'
        db.create_table('waiter_waiter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('waiter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=30)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('waiter', ['Waiter'])


    def backwards(self, orm):
        # Deleting model 'Waiter'
        db.delete_table('waiter_waiter')
