...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_orders', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('items', self.gf('django.db.models.fields.TextField')(max_length=100)),
            ('amount', self.gf('django.db.models.fields.TextField')(max_length=20)),
        ))
    ...
    models = {
        ...
        'orders.orders': {
            ...
            'amount': ('django.db.models.fields.TextField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.TextField', [], {'max_length': '100'})
        },
        'orders.statusorders': {
