...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_sales', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Stock'], unique=True)),
            ('count', self.gf('django.db.models.fields.IntegerField')(max_length=2000)),
        ))
    ...
    models = {
        'orders.sales': {
            ...
            'count': ('django.db.models.fields.IntegerField', [], {'max_length': '2000'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Stock']", 'unique': 'True'})
        },
        'orders.statusorders': {
